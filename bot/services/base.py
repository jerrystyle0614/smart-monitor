...
class ScriptedService:
    ...
    def start(self, uid: str, store, line, reply_token: str = "") -> None:
        ...
        self._show_step(uid, 0, store, line, reply_token)

    def handle_input(self, uid: str, text: str, store, line, reply_token: str = "") -> str:
        """
        處理使用者輸入。
        ...
        if text == "跳過":
            ...
            self._show_step(uid, next_step, store, line, reply_token)
            return "CONTINUE"
    ...
    def _show_step(self, uid: str, step_index: int, store, line, reply_token: str = "") -> None:
        """顯示指定步驟的問題"""
